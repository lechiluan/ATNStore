     ...
     <?php
		...
		if(isset($_POST["btnAdd"]))
		{
			...
			else
			{
				...
				$sq="SELECT * FROM suppliers where supid='$id' or supname='$name'";
				$result = pg_query($conn,$sq);
				if(pg_num_rows($result)==0)
				{
					pg_query($conn, "INSERT INTO suppliers (supid, supname, supdesc) VALUES ('$id','$name','$des')");
     ...
     <div class="container">
         ...
         <form id="form1" name="form1" method="post" action="" class="form-horizontal" role="form">
             <div class="form-group">
                 ...
                 <div class="col-sm-10">
                     <input type="text" name="txtID" id="txtID" class="form-control" placeholder="Suppliers ID"
             ...
             <div class="form-group">
                 ...
                 <div class="col-sm-10">
                     <input type="text" name="txtName" id="txtName" class="form-control" placeholder="Suppliers Name"
