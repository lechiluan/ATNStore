...
<body>
    ...
    $err = "";
    if($us=="" || $pass1=="" || $pass2=="" || $fullname=="" || $email=="" || $addrress=="" || !isset($sex))
    {
    ...
    if($_POST['slYear']=="0")
    {
        $err .="<li>Chose Year of Birth, please</li>";
    }
    if($err!="")
    {
        echo $err;
    ...
    else
    {
        ...
        {
            pg_query($conn,"INSERT INTO customer(username, password, cusName, 
            gender, address, telephone, email, cusdate, cusmonth, cusyear, state)
    ...
    <div class="container">
        ...
        <form id="form1" name="form1" method="post" action="" class="form-horizontal" role="form">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" name="txtFullname" id="txtFullname" value="" class="form-control"
            ...
            <div class="form-group">
                <label for="lblDienThoai" class="col-sm-2 control-label">Phone Number(*): </label>
                <div class="col-sm-10">
                    <input type="text" name="txtTel" id="txtTel" value="" class="form-control"
