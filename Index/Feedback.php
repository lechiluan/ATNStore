...
<?php 
	if (isset($_POST['btnSummit'])) 
	{
	  if($_POST['txtEmail']!="" && $_POST['txtMessage']!="")
        ...
        pg_query($conn,"INSERT INTO feedback (username, telephone, email, message) VALUES ('$us','$phone','$email','$mess')");
                ...
                <form class="form-horizontal" method="post">
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input id="txtPhone" name="txtPhone" type="text" placeholder="Your phone"
                                    class="form-control">
                            </div>
                        </div>
                        <!-- Email input-->
